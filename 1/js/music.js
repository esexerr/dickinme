...
button.addEventListener("click", (() => {
    audio.paused ? (audio.volume = .1, audio.play(), icon.classList.remove("fas-volume-up"), icon.classList.add("fa-volume-mute")) : (audio.pause(), icon.classList.remove("fa-volume-mute"), icon.classList.add("fa-volume-up")), button.classList.add("replace"), blur.classList.add("blurpagerplc"), change()
}));
(function(o, d, l) {
    try {
